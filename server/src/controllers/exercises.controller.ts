...
router.post(
    ...
    async (
        ...
        try {
            const exercise = await exerciseService.executeExerciseBuilder(
                req.body
            );
...
router.post(
    ...
    async (req: any, res: express.Response) => {
        try {
            const exercises = await exerciseService.executeExerciseBuilder(
                req.body
            );
...
router.post(
    ...
    async (req: any, res: express.Response) => {
        try {
            const exerciseEquipments = await exerciseService.getEquipments(
                req.body
            );
